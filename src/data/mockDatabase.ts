...
export const STATES: State[] = [
  ...
  { id: 'andaman-nicobar', name: 'Andaman & Nicobar Islands', code: 'AN', type: 'ut', popularSchemesCount: 15, capital: 'Port Blair' },
  { id: 'andhra-pradesh', name: 'Andhra Pradesh', code: 'AP', type: 'state', popularSchemesCount: 26, capital: 'Amaravati' },
  { id: 'arunachal-pradesh', name: 'Arunachal Pradesh', code: 'AR', type: 'state', popularSchemesCount: 18, capital: 'Itanagar' },
  { id: 'assam', name: 'Assam', code: 'AS', type: 'state', popularSchemesCount: 24, capital: 'Dispur' },
  { id: 'bihar', name: 'Bihar', code: 'BR', type: 'state', popularSchemesCount: 24, capital: 'Patna' },
  { id: 'chandigarh', name: 'Chandigarh', code: 'CH', type: 'ut', popularSchemesCount: 12, capital: 'Chandigarh' },
  { id: 'chhattisgarh', name: 'Chhattisgarh', code: 'CG', type: 'state', popularSchemesCount: 20, capital: 'Raipur' },
  { id: 'dadra-nagar-haveli-daman-diu', name: 'Dadra & Nagar Haveli and Daman & Diu', code: 'DN', type: 'ut', popularSchemesCount: 10, capital: 'Daman' },
  { id: 'delhi', name: 'Delhi', code: 'DL', type: 'ut', popularSchemesCount: 20, capital: 'New Delhi' },
  { id: 'goa', name: 'Goa', code: 'GA', type: 'state', popularSchemesCount: 14, capital: 'Panaji' },
  { id: 'gujarat', name: 'Gujarat', code: 'GJ', type: 'state', popularSchemesCount: 30, capital: 'Gandhinagar' },
  { id: 'haryana', name: 'Haryana', code: 'HR', type: 'state', popularSchemesCount: 21, capital: 'Chandigarh' },
  { id: 'himachal-pradesh', name: 'Himachal Pradesh', code: 'HP', type: 'state', popularSchemesCount: 17, capital: 'Shimla' },
  { id: 'jammu-kashmir', name: 'Jammu & Kashmir', code: 'JK', type: 'ut', popularSchemesCount: 25, capital: 'Srinagar/Jammu' },
  { id: 'jharkhand', name: 'Jharkhand', code: 'JH', type: 'state', popularSchemesCount: 19, capital: 'Ranchi' },
  ...
  { id: 'ladakh', name: 'Ladakh', code: 'LA', type: 'ut', popularSchemesCount: 14, capital: 'Leh' },
  { id: 'lakshadweep', name: 'Lakshadweep', code: 'LD', type: 'ut', popularSchemesCount: 8, capital: 'Kavaratti' },
  ...
  { id: 'manipur', name: 'Manipur', code: 'MN', type: 'state', popularSchemesCount: 13, capital: 'Imphal' },
  { id: 'meghalaya', name: 'Meghalaya', code: 'ML', type: 'state', popularSchemesCount: 15, capital: 'Shillong' },
  { id: 'mizoram', name: 'Mizoram', code: 'MZ', type: 'state', popularSchemesCount: 11, capital: 'Aizawl' },
  { id: 'nagaland', name: 'Nagaland', code: 'NL', type: 'state', popularSchemesCount: 12, capital: 'Kohima' },
  { id: 'odisha', name: 'Odisha', code: 'OR', type: 'state', popularSchemesCount: 26, capital: 'Bhubaneswar' },
  { id: 'puducherry', name: 'Puducherry', code: 'PY', type: 'ut', popularSchemesCount: 16, capital: 'Puducherry' },
  ...
  { id: 'sikkim', name: 'Sikkim', code: 'SK', type: 'state', popularSchemesCount: 10, capital: 'Gangtok' },
  ...
  { id: 'tripura', name: 'Tripura', code: 'TR', type: 'state', popularSchemesCount: 14, capital: 'Agartala' },
  { id: 'uttar-pradesh', name: 'Uttar Pradesh', code: 'UP', type: 'state', popularSchemesCount: 38, capital: 'Lucknow' },
  { id: 'uttarakhand', name: 'Uttarakhand', code: 'UK', type: 'state', popularSchemesCount: 18, capital: 'Dehradun' },
